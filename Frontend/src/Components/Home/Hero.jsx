      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Take control of your travel expenses with our comprehensive
            budgeting tool. Plan smarter, track better, and travel with
            confidence knowing your finances are well-managed.
          </p>
          <Link to="/login">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-white">
          <div className="text-center max-w-4xl px-4">
            ...
            <p className="text-lg md:text-xl">
              Track expenses, set budgets, and make informed decisions
